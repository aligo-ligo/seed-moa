...
export const GOAL_TITLE = "당신의 목표는 무엇인가요?";
export const GOAL_DESCRIPTION = "이루고자 하는 최종 목표를 적어주세요";

export const SUBGOAL_TITLE = "목표를 위한 세분화 목표와 루틴을 작성해주세요";
export const SUBGOAL_DESCRIPTION =
	"목표를 달성하기 위해서는 반드시 필요한 작업들이 있어요. 바로 이게 그 작업이에요. 작은 목표를 세우고 루틴을 만든다면 목표를 달성하는데 도움이 될거예요 파이팅!";
