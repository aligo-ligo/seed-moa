  ...
  ({ children = "3초만에 카카오 로그인", ...props }, ref) => {
    return (
      <a
        ref={ref}
        {...props}
        className="relative flex justify-center items-center w-full text-sm font-bold mt-5 hover:opacity-80 rounded-xl border-none px-4 py-5 bg-[#fee500] cursor-pointer"
      >
